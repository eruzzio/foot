...
export default function FieldVisualization({ players, positions, onPositionClick, onAssignPlayer }: FieldVisualizationProps) {
  ...
  return (
    <div
      className="relative w-full bg-gradient-to-b from-green-600 to-green-700 rounded-lg shadow-xl overflow-hidden"
      style={{ paddingBottom: '140%', maxHeight: 480, maxWidth: 340, margin: '0 auto' }}
              ...
              {isSelecting && !player ? (
                <div className="flex flex-col items-center gap-2" style={{ minWidth: 'min(200px, 80vw)' }}>
                  <select
                    ...
                    className="w-full px-2 py-1.5 border border-blue-500 text-xs font-medium focus:outline-none" style={{ background:"var(--orion-surface)", color:"var(--orion-text)" }}
                    defaultValue=""
                  >
