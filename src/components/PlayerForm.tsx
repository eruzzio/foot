                ...
                <>
                  ...
                  <div>
                    ...
                    <div className="flex items-center gap-3">
                      <input type="date" value={formData.birth_date} onChange={e => setFormData(f => ({ ...f, birth_date: e.target.value }))} className="flex-1 px-3 py-2 bg-dark-tertiary border border-gray-600 text-white text-sm focus:outline-none focus:ring-2 focus:ring-orange-primary" style={{ colorScheme: 'dark' }} />
