...
export default function MatchTags({ matchId, match, onUpdate }: MatchTagsProps) {
    ...
    <button
      ...
      className={`flex items-center gap-2 px-3 py-2 rounded-lg text-sm font-medium transition-all ${
        current === value
          ...
          : 'bg-dark-tertiary text-gray-400 border border-gray-700 hover:text-white hover:border-gray-600'
      }`}
    >
      <span>{emoji}</span>
      <span>{label}</span>
  ...
  return (
    <div className="bg-dark-secondary border border-gray-800 rounded-xl p-6 space-y-6">
      ...
      <div>
        ...
        <input
          ...
          className="w-full px-3 py-2 bg-dark-tertiary border border-gray-700 text-white rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-orange-primary placeholder-gray-600"
        />
      </div>
      ...
      <div>
        ...
        <textarea
          ...
          className="w-full px-3 py-2 bg-dark-tertiary border border-gray-700 text-white rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-orange-primary placeholder-gray-600 resize-none"
        />
      </div>
        ...
        <div className="bg-dark-tertiary rounded-lg p-3">
          ...
          <div className="flex flex-wrap gap-2">
            {tags.tag_competition && (
              <span className="px-2 py-1 bg-orange-primary/20 text-orange-300 rounded-full text-xs font-medium border border-orange-primary/30">
                🏆 {tags.tag_competition}
              </span>
            )}
            {tags.tag_venue && (
