...
export function exportToPdf(data: PdfExportData): void {
  ...
  const fieldPts = fieldEvents.map(e => {
    ...
    return `<circle cx="${(e.field_x! / 100) * 420 + 10}" cy="${(e.field_y! / 100) * 660 + 10}" r="6" fill="${c}" stroke="white" stroke-width="1.5" opacity="0.85"/>`;
  }).join('');
...
<div><h2>Heatmap terrain</h2><div class="card" style="padding:3px;"><svg viewBox="0 0 440 680" xmlns="http://www.w3.org/2000/svg" style="width:100%;border-radius:4px;"><rect width="440" height="680" fill="#1A6B35" rx="4"/><rect x="10" y="10" width="420" height="660" fill="none" stroke="#2A8A4A" stroke-width="2"/><line x1="10" y1="340" x2="430" y2="340" stroke="#2A8A4A" stroke-width="1.5"/><circle cx="220" cy="340" r="50" fill="none" stroke="#2A8A4A" stroke-width="1.5"/><rect x="130" y="10" width="180" height="80" fill="none" stroke="#2A8A4A" stroke-width="1.5"/><rect x="130" y="590" width="180" height="80" fill="none" stroke="#2A8A4A" stroke-width="1.5"/>${fieldPts}</svg></div></div>
<div><h2>Répartition par zone</h2><div class="card" style="padding:3px;"><svg viewBox="0 0 440 680" xmlns="http://www.w3.org/2000/svg" style="width:100%;border-radius:4px;"><rect width="440" height="680" fill="#1A6B35" rx="4"/><rect x="10" y="10" width="420" height="660" fill="none" stroke="#2A8A4A" stroke-width="2"/><line x1="10" y1="340" x2="430" y2="340" stroke="#2A8A4A" stroke-width="1.5"/><circle cx="220" cy="340" r="50" fill="none" stroke="#2A8A4A" stroke-width="1.5"/><rect x="10" y="10" width="420" height="220" fill="rgba(239,68,68,0.2)"/><line x1="10" y1="230" x2="430" y2="230" stroke="rgba(239,68,68,0.5)" stroke-width="2" stroke-dasharray="8,4"/><text x="220" y="115" text-anchor="middle" font-size="32" fill="white" font-weight="900" font-family="sans-serif">${zO}</text><text x="220" y="140" text-anchor="middle" font-size="11" fill="rgba(255,200,200,0.8)" font-weight="600" font-family="sans-serif">OFF (${Math.round((zO/zT)*100)}%)</text><rect x="10" y="230" width="420" height="220" fill="rgba(250,204,21,0.15)"/><line x1="10" y1="450" x2="430" y2="450" stroke="rgba(250,204,21,0.5)" stroke-width="2" stroke-dasharray="8,4"/><text x="220" y="345" text-anchor="middle" font-size="32" fill="white" font-weight="900" font-family="sans-serif">${zM}</text><text x="220" y="370" text-anchor="middle" font-size="11" fill="rgba(255,240,180,0.8)" font-weight="600" font-family="sans-serif">MED (${Math.round((zM/zT)*100)}%)</text><rect x="10" y="450" width="420" height="220" fill="rgba(59,130,246,0.2)"/><text x="220" y="565" text-anchor="middle" font-size="32" fill="white" font-weight="900" font-family="sans-serif">${zD}</text><text x="220" y="590" text-anchor="middle" font-size="11" fill="rgba(180,210,255,0.8)" font-weight="600" font-family="sans-serif">DEF (${Math.round((zD/zT)*100)}%)</text></svg></div></div>
